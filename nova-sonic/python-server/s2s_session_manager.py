...
class S2sSessionManager:
    ...
    def _initialize_client(self):
        ...
        self.bedrock_client = BedrockRuntimeClient(config=bedrock_config)
                ...
                if result.value and result.value.bytes_:
                    ...
                    if 'event' in json_data:
                        ...
                        # Process tool use when content ends
                            ...
                            logger.info(f"Processing tool use '{self.toolName}' and sending result")
            ...
            if toolName == "getbookingdetails":
                try:
                    ...
                    try:
                        ...
                        logger.warning(f"Not JSON or formatting error: {str(e)}")
